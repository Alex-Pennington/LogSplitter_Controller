...
const char* const ALLOWED_COMMANDS[] = {
    "help", "show", "pins", "pin", "set", "relay", "debug", "network", "reset", "test", "syslog", "loglevel", "heartbeat", "error", nullptr
};
...
const char* const ALLOWED_SET_PARAMS[] = {
    ...
    "pinmode", "seqstable", "seqstartstable", "seqtimeout", "debug", "debugpins", "loglevel", "syslog", nullptr
};